...
;End Battle
Global $g_aGroupEndBattleDB = "", $groupEndBattkeAB = "", $groupKingSleeping = "", $groupQueenSleeping = "", $groupPrinceSleeping = "", $groupDukeSleeping = "", $groupWardenSleeping = "", $groupCloseWhileTraining = "", _
...
Func InitializeControlVariables()
	...
	$groupHerosDB = $g_hPicDBHeroesWait & "#" & $g_hTxtDBHeroesWait & "#" & $g_hChkDBKingWait & "#" & $g_hChkDBQueenWait & "#" & $g_hChkDBPrinceWait & "#" & $g_hChkDBWardenWait & "#" & $g_hChkDBChampionWait & "#" & $g_hChkDBDukeWait & "#" & $g_hPicDBKingWait & "#" & _
			$g_hPicDBQueenWait & "#" & $g_hPicDBPrinceWait & "#" & $g_hPicDBWardenWait & "#" & $g_hPicDBChampionWait & "#" & $g_hPicDBDukeWait & "#" & $g_hChkDBNotWaitHeroes
	...
	$groupHerosAB = $g_hPicABHeroesWait & "#" & $g_hTxtABHeroesWait & "#" & $g_hChkABKingWait & "#" & $g_hChkABQueenWait & "#" & $g_hChkABPrinceWait & "#" & $g_hChkABWardenWait & "#" & $g_hChkABChampionWait & "#" & $g_hChkABDukeWait & "#" & _
			$g_hPicABKingWait & "#" & $g_hPicABQueenWait & "#" & $g_hPicABPrinceWait & "#" & $g_hPicABWardenWait & "#" & $g_hPicABChampionWait & "#" & $g_hPicABDukeWait & "#" & $g_hChkABNotWaitHeroes
	...
	;Attack
	$g_aGroupAttackDB = $g_hCmbDBAlgorithm & "#" & $g_hCmbDBSelectTroop & "#" & $g_hChkDBKingAttack & "#" & $g_hChkDBQueenAttack & "#" & $g_hChkDBPrinceAttack & "#" & $g_hChkDBWardenAttack & "#" & $g_hChkDBChampionAttack & "#" & $g_hChkDBDukeAttack & "#" & $g_hChkDBDropCC & "#" & _
	...
	$g_aGroupAttackDBSpell = $g_hChkDBLightSpell & "#" & $g_hChkDBHealSpell & "#" & $g_hChkDBRageSpell & "#" & $g_hChkDBJumpSpell & "#" & $g_hChkDBFreezeSpell & "#" & $g_hChkDBCloneSpell & "#" & _
			$g_hChkDBInvisibilitySpell & "#" & $g_hChkDBRecallSpell & "#" & $g_hChkDBReviveSpell & "#" & $g_hChkDBPoisonSpell & "#" & $g_hChkDBEarthquakeSpell & "#" & $g_hChkDBHasteSpell & "#" & $g_hChkDBSkeletonSpell & "#" & $g_hChkDBBatSpell & "#" & _
			$g_hChkDBOvergrowthSpell
	$groupIMGAttackDB = $g_hPicDBKingAttack & "#" & $g_hPicDBQueenAttack & "#" & $g_hPicDBPrinceAttack & "#" & $g_hPicDBWardenAttack & "#" & $g_hPicDBChampionAttack & "#" & $g_hPicDBDukeAttack & "#" & $g_hPicDBDropCC & "#" & _
	...
	$groupAttackAB = $g_hCmbDBAlgorithm & "#" & $g_hCmbABSelectTroop & "#" & $g_hChkABKingAttack & "#" & $g_hChkABQueenAttack & "#" & $g_hChkABPrinceAttack & "#" & $g_hChkABWardenAttack & "#" & $g_hChkABChampionAttack & "#" & $g_hChkABDukeAttack & "#" & $g_hChkABDropCC & "#" & _
	...
	$groupAttackABSpell = $g_hChkABLightSpell & "#" & $g_hChkABHealSpell & "#" & $g_hChkABRageSpell & "#" & $g_hChkABJumpSpell & "#" & $g_hChkABFreezeSpell & "#" & $g_hChkABCloneSpell & "#" & _
			$g_hChkABInvisibilitySpell & "#" & $g_hChkABRecallSpell & "#" & $g_hChkABReviveSpell & "#" & $g_hChkABPoisonSpell & "#" & $g_hChkABEarthquakeSpell & "#" & $g_hChkABHasteSpell & "#" & $g_hChkABSkeletonSpell & "#" & $g_hChkABBatSpell & "#" & _
			$g_hChkABOvergrowthSpell
	$groupIMGAttackAB = $g_hPicABKingAttack & "#" & $g_hPicABQueenAttack & "#" & $g_hPicABPrinceAttack & "#" & $g_hPicABWardenAttack & "#" & $g_hPicABChampionAttack & "#" & $g_hPicABDukeAttack & "#" & $g_hPicABDropCC & "#" & _
	...
	$groupDukeSleeping = $g_hPicDBDukeSleepWait & "#" & $g_hPicABDukeSleepWait & "#" & $g_hPicChkDukeSleepWait
