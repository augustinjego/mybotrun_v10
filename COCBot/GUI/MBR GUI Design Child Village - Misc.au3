...
Global $g_ahCGMainLootItem[6], $g_ahCGMainBattleItem[22], $g_ahCGMainDestructionItem[34], $g_ahCGMainAirItem[13], _
		$g_ahCGMainGroundItem[29], $g_ahCGEquipmentItem[26], $g_ahCGMainMiscItem[3], $g_ahCGMainSpellItem[12], $g_ahCGBBBattleItem[4], _
...
Func CreateMiscNormalVillageSubTab()
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetData(-1, GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "CmbBotCond_Item_01", "G and E Full and Max.League") & "|" & _
			GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "CmbBotCond_Item_02", "(G and E) Full or Max.League") & "|" & _
			GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "CmbBotCond_Item_03", "(G or E) Full and Max.League") & "|" & _
			GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "CmbBotCond_Item_04", "G or E Full or Max.League") & "|" & _
			...
			GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "CmbBotCond_Item_07", "Gold Full and Max.League") & "|" & _
			GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "CmbBotCond_Item_08", "Elixir Full and Max.League") & "|" & _
			GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "CmbBotCond_Item_09", "Gold Full or Max.League") & "|" & _
			GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "CmbBotCond_Item_10", "Elixir Full or Max.League") & "|" & _
			...
			GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "CmbBotCond_Item_13", "Reach Max. League Tier") & "|" & _
	...
	GUICtrlSetLimit(-1, 2) ; league tier is 1-36 since CoC 18.600, not a trophy count any more
	...
	_GUICtrlSetImage(-1, $g_sLibIconPath, $eIcnTH17, 1)
	...
	$x += 40
	$g_hBtnLocateHeroHall = GUICtrlCreateButton(GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "BtnLocateHeroHall", "Hero Hall"), $x, $y, 36, 36, $BS_ICON)
	_GUICtrlSetImage(-1, $g_sLibIconPath, $eIcnHeroHall)
	_GUICtrlSetTip(-1, $sTxtRelocate & GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "BtnLocateHeroHall_Info_01", "Hero Hall"))
	...
	$x += 40
	$g_hBtnLocateHelperHut = GUICtrlCreateButton(GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "BtnLocateHelperHut", "Helper Hut"), $x, $y, 36, 36, $BS_ICON)
	_GUICtrlSetImage(-1, $g_sLibIconPath, $eIcnHelperHut)
...
Func CreateClanCapitalTab()
	...
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "InputForgeUseBuilder", "Put How many builder to use to Forge") & @CRLF & _
			GetTranslatedFileIni("MBR GUI Design Child Village - Misc", "InputForgeUseBuilder2", "Set ""0"" To Use Auto Forge Slot."))
