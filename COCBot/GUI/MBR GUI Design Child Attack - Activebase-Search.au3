...
Func CreateAttackSearchActiveBaseSearch()
	...
	$g_ahCmbWeakMortar[$LB] = GUICtrlCreateCombo("", $x + 19, $y, 54, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	...
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_ahPicWeakMortar[$LB] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnMortar, $x + 76, $y - 2, 24, 24)
	_GUICtrlSetTip(-1, $sTxtTip)
	...
	GUICtrlSetOnEvent(-1, "chkABWeakBase")
	$g_ahCmbWeakXBow[$LB] = GUICtrlCreateCombo("", $x + 19, $y, 54, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	...
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_ahPicWeakXBow[$LB] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnXBow3, $x + 76, $y - 2, 24, 24)
	_GUICtrlSetTip(-1, $sTxtTip)
	...
	GUICtrlSetOnEvent(-1, "chkABWeakBase")
	$g_ahCmbWeakScatter[$LB] = GUICtrlCreateCombo("", $x + 19, $y, 51, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	...
	GUICtrlSetOnEvent(-1, "chkABWeakBase")
	$g_ahCmbWeakInferno[$LB] = GUICtrlCreateCombo("", $x + 19, $y, 51, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	...
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_ahPicWeakInferno[$LB] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnInferno4, $x + 76, $y - 2, 24, 24)
	_GUICtrlSetTip(-1, $sTxtTip)
	...
	GUICtrlSetOnEvent(-1, "chkABWeakBase")
	$g_ahCmbWeakEagle[$LB] = GUICtrlCreateCombo("", $x + 19, $y, 51, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	...
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_ahPicWeakEagle[$LB] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnEagleArt, $x + 76, $y - 2, 24, 24)
	_GUICtrlSetTip(-1, $sTxtTip)

	$y += 24
	$g_ahChkMaxMonolith[$LB] = GUICtrlCreateCheckbox("", $x, $y, 17, 17)
	...
	GUICtrlSetOnEvent(-1, "chkABWeakBase")
	$g_ahCmbWeakMonolith[$LB] = GUICtrlCreateCombo("", $x + 19, $y, 51, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
