...
; Return values .: None
; Author ........:
; Modified ......: CodeSlinger69 (01-2017), Moebius14 (06-2023)
...
Global $g_hChkDBPrinceWait = 0, $g_hPicDBPrinceWait = 0, $g_hPicDBPrinceSleepWait = 0
...
Func CreateAttackSearchDeadBaseSearch()
	...
	$y += 20
	$x += 23
	$g_hChkDBKingWait = GUICtrlCreateCheckbox("", $x - 9, $y + 35, 16, 16)
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hPicDBKingWait = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnKing, $x - 15, $y + 5, 25, 25)
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hPicDBKingSleepWait = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnSleepingKing, $x - 15, $y + 5, 25, 25)
	GUICtrlSetState(-1, $GUI_HIDE)

	$x += 35
	$g_hChkDBQueenWait = GUICtrlCreateCheckbox("", $x - 9, $y + 35, 16, 16)
	$sTxtTip = GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "TxtQueenWait_Info_01", "Wait for Queen to be ready before attacking...") & @CRLF & _
			GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "TxtQueenWait_Info_02", "Enabled with TownHall 8 and higher")
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hPicDBQueenWait = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnQueen, $x - 15, $y + 5, 25, 25)
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hPicDBQueenSleepWait = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnSleepingQueen, $x - 15, $y + 5, 25, 25)
	GUICtrlSetState(-1, $GUI_HIDE)

	$x += 35
	$g_hChkDBPrinceWait = GUICtrlCreateCheckbox("", $x - 9, $y + 35, 16, 16)
	$sTxtTip = GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "TxtPrinceWait_Info_01", "Wait for Prince to be ready before attacking...") & @CRLF & _
			GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "TxtPrinceWait_Info_02", "Enabled with TownHall 9 and higher")
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hPicDBPrinceWait = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnPrince, $x - 15, $y + 5, 25, 25)
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hPicDBPrinceSleepWait = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnSleepingPrince, $x - 15, $y + 5, 25, 25)
	GUICtrlSetState(-1, $GUI_HIDE)

	$x += 35
	$g_hChkDBWardenWait = GUICtrlCreateCheckbox("", $x - 9, $y + 35, 16, 16)
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hPicDBWardenWait = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnWarden, $x - 15, $y + 5, 25, 25)
	_GUICtrlSetTip(-1, $sTxtTip)
	$g_hPicDBWardenSleepWait = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnSleepingWarden, $x - 15, $y + 5, 25, 25)
	GUICtrlSetState(-1, $GUI_HIDE)

	$x += 35
	$g_hChkDBChampionWait = GUICtrlCreateCheckbox("", $x - 9, $y + 35, 16, 16)
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetState(-1, $GUI_HIDE)
	$g_ahPicDBMaxTH[15] = _GUICtrlCreateIcon($g_sLibIconPath, $eHdV15, $x + 137, $y - 3, 24, 24)
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetState(-1, $GUI_HIDE)
	$g_ahPicDBMaxTH[16] = _GUICtrlCreateIcon($g_sLibIconPath, $eHdV16, $x + 137, $y - 3, 24, 24)
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetState(-1, $GUI_HIDE)
	...
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkMaxMortar", "Search for a base that has Mortar below or equal this level."))
	GUICtrlSetOnEvent(-1, "chkDBWeakBase")
	$g_ahCmbWeakMortar[$DB] = GUICtrlCreateCombo("", $x + 19, $y, 54, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetData(-1, "-|Lvl 1|Lvl 2|Lvl 3|Lvl 4|Lvl 5|Lvl 6|Lvl 7|Lvl 8|Lvl 9|Lvl 10|Lvl 11|Lvl 12|Lvl 13|Lvl 14|Lvl 15|Lvl 16", "Lvl 5")
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_ahPicWeakMortar[$DB] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnMortar, $x + 76, $y - 2, 24, 24)
	_GUICtrlSetTip(-1, $sTxtTip)

	$y += 24
	$g_ahChkMaxWizTower[$DB] = GUICtrlCreateCheckbox("", $x, $y, 17, 17)
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkMaxWizTower", "Search for a base that has Wizard Tower below or equal this level"))
	GUICtrlSetOnEvent(-1, "chkDBWeakBase")
	$g_ahCmbWeakWizTower[$DB] = GUICtrlCreateCombo("", $x + 19, $y, 54, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	...
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_ahPicWeakWizTower[$DB] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnWizTower, $x + 76, $y - 2, 24, 24)
	_GUICtrlSetTip(-1, $sTxtTip)

	$y += 24
	$g_ahChkMaxAirDefense[$DB] = GUICtrlCreateCheckbox("", $x, $y, 17, 17)
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkMaxAirDefense", "Search for a base that has Air Defense below or equal this level"))
	GUICtrlSetOnEvent(-1, "chkDBWeakBase")
	$g_ahCmbWeakAirDefense[$DB] = GUICtrlCreateCombo("", $x + 19, $y, 54, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	...
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_ahPicWeakAirDefense[$DB] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnAirdefense, $x + 76, $y - 2, 24, 24)
	_GUICtrlSetTip(-1, $sTxtTip)

	$y += 24
	$g_ahChkMaxXBow[$DB] = GUICtrlCreateCheckbox("", $x, $y, 17, 17)
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkMaxXBow", "Search for a base that has X-Bow below or equal this level"))
	GUICtrlSetOnEvent(-1, "chkDBWeakBase")
	$g_ahCmbWeakXBow[$DB] = GUICtrlCreateCombo("", $x + 19, $y, 54, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetData(-1, "-|Lvl 1|Lvl 2|Lvl 3|Lvl 4|Lvl 5|Lvl 6|Lvl 7|Lvl 8|Lvl 9|Lvl 10|Lvl 11", "Lvl 2")
	GUICtrlSetState(-1, $GUI_DISABLE)
	...
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkMaxScatter", "Search for a base that has ScatterShot below or equal this level"))
	GUICtrlSetOnEvent(-1, "chkDBWeakBase")
	...
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkMaxInferno", "Search for a base that has Inferno below or equal this level"))
	GUICtrlSetOnEvent(-1, "chkDBWeakBase")
	$g_ahCmbWeakInferno[$DB] = GUICtrlCreateCombo("", $x + 19, $y, 51, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetData(-1, "-|Lvl 1|Lvl 2|Lvl 3|Lvl 4|Lvl 5|Lvl 6|Lvl 7|Lvl 8|Lvl 9", "Lvl 2")
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_ahPicWeakInferno[$DB] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnInferno4, $x + 76, $y - 2, 24, 24)
	_GUICtrlSetTip(-1, $sTxtTip)

	$y += 24
	$g_ahChkMaxEagle[$DB] = GUICtrlCreateCheckbox("", $x, $y, 17, 17)
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkMaxEagle", "Search for a base that has Eagle Artillery below or equal this level"))
	GUICtrlSetOnEvent(-1, "chkDBWeakBase")
	...
	_GUICtrlSetTip(-1, $sTxtTip)
	GUICtrlSetData(-1, "-|Lvl 1|Lvl 2|Lvl 3|Lvl 4|Lvl 5|Lvl 6", "Lvl 1")
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_ahPicWeakEagle[$DB] = _GUICtrlCreateIcon($g_sLibIconPath, $eIcnEagleArt, $x + 76, $y - 2, 24, 24)
	_GUICtrlSetTip(-1, $sTxtTip)

	$y += 24
	$g_ahChkMaxMonolith[$DB] = GUICtrlCreateCheckbox("", $x, $y, 17, 17)
	_GUICtrlSetTip(-1, GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "ChkMaxMonolith", "Search for a base that has Monolith below or equal this level"))
	GUICtrlSetOnEvent(-1, "chkDBWeakBase")
	$g_ahCmbWeakMonolith[$DB] = GUICtrlCreateCombo("", $x + 19, $y, 51, -1, BitOR($CBS_DROPDOWNLIST, $CBS_AUTOHSCROLL))
	$sTxtTip = GetTranslatedFileIni("MBR GUI Design Child Attack - Search", "CmbMaxMonolith_Info_01", "Set the Max. level of the Monolith to search for on a village to attack.")
	_GUICtrlSetTip(-1, $sTxtTip)
