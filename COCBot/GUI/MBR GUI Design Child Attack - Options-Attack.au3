...
; Hero abilities
Global $g_hRadAutoQueenAbility = 0, $g_hRadAutoKingAbility = 0, $g_hRadAutoPrinceAbility = 0, $g_hRadAutoWardenAbility = 0, $g_hRadAutoChampionAbility = 0, $g_hRadAutoDukeAbility = 0
Global $g_hRadManQueenAbility = 0, $g_hRadManKingAbility = 0, $g_hRadManPrinceAbility = 0, $g_hRadManWardenAbility = 0, $g_hRadManChampionAbility = 0, $g_hRadManDukeAbility = 0
Global $g_hTxtManQueenAbility = 0, $g_hTxtManKingAbility = 0, $g_hTxtManPrinceAbility = 0, $g_hTxtManWardenAbility = 0, $g_hTxtManChampionAbility = 0, $g_hTxtManDukeAbility = 0
Global $g_hRadBothQueenAbility = 0, $g_hRadBothKingAbility = 0, $g_hRadBothPrinceAbility = 0, $g_hRadBothWardenAbility = 0, $g_hRadBothChampionAbility = 0, $g_hRadBothDukeAbility = 0
...
Func CreateAttackSearchOptionsAttack()
	...
	Local $sTxtTip = ""
	Local $x = 25, $y = 45
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Attack", "Group_01", "Hero Abilities"), $x - 20, $y - 20, $g_iSizeWGrpTab4, 145)
	_GUICtrlCreateIcon($g_sLibIconPath, $eIcnQueen, $x, $y, 20, 20)
	GUIStartGroup()
	$x += 30
	...
	Local $x = 25, $y = 65
	_GUICtrlCreateIcon($g_sLibIconPath, $eIcnKing, $x, $y, 20, 20)
	GUIStartGroup()
	$x += 30
	...
	Local $x = 25, $y = 85
	_GUICtrlCreateIcon($g_sLibIconPath, $eIcnPrince, $x, $y, 20, 20)
	GUIStartGroup()
	$x += 30
	...
	Local $x = 25, $y = 105
	_GUICtrlCreateIcon($g_sLibIconPath, $eIcnWarden, $x, $y, 20, 20)
	GUIStartGroup()
	$x += 30
	...
	Local $x = 25, $y = 125
	_GUICtrlCreateIcon($g_sLibIconPath, $eIcnChampion, $x, $y, 20, 20)
	GUIStartGroup()
	$x += 30
	...
	Local $x = 25, $y = 145
	_GUICtrlCreateIcon($g_sLibIconPath, $eIcnDuke, $x, $y, 20, 20)
	GUIStartGroup()
	$x += 30
	...
	Local $x = 25, $y = 190
	GUICtrlCreateGroup(GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Attack", "Group_02", "Attack Schedule"), $x - 20, $y - 20, $g_iSizeWGrpTab4, 118)
	$x -= 5
	...
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_hChkAttackPlannerDayLimit = GUICtrlCreateCheckbox(GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Attack", "ChkAttackPlannerDayLimit", "Daily Limit"), $x + 185, $y + 72, -1, -1)
	...
	$g_hCmbAttackPlannerDayMin = GUICtrlCreateInput("12", $x + 260, $y + 74, 37, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
	...
	$g_hLbAttackPlannerDayLimit = GUICtrlCreateLabel(GetTranslatedFileIni("MBR GUI Design Child Attack - Options-Attack", "LbAttackPlannerDayLimit", "To"), $x + 302, $y + 76, -1, -1)
	GUICtrlSetState(-1, $GUI_DISABLE)
	$g_hCmbAttackPlannerDayMax = GUICtrlCreateInput("15", $x + 317, $y + 74, 37, 18, BitOR($GUI_SS_DEFAULT_INPUT, $ES_CENTER, $ES_NUMBER))
