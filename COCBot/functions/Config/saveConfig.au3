...
Func SaveConfig_600_15()
	...
	_Ini_Add("upgrade", "UpgradeDuke", $g_bUpgradeDukeEnable ? 1 : 0)
	_Ini_Add("upgrade", "RepUpgradeDuke", $g_bRepUpgradeDukeEnable ? 1 : 0)
...
Func SaveConfig_600_18()
	...
	_Ini_Add("notify", "DiscordWebhook", $g_sNotifyDiscordWebhook)
	_Ini_Add("notify", "DiscordFullLog", $g_bNotifyDiscordFullLog ? 1 : 0)
...
Func SaveConfig_600_28_DB()
	...
	_Ini_Add("attack", "DBDukeWait", $g_iHeroWaitAttackNoBit[$DB][5])
...
Func SaveConfig_600_28_LB()
	...
	_Ini_Add("attack", "ABDukeWait", $g_iHeroWaitAttackNoBit[$LB][5])
...
Func SaveConfig_600_29_DB()
	...
	_Ini_Add("attack", "DBDukeAtk", BitAND($g_aiAttackUseHeroes[$DB], $eHeroDuke))
...
Func SaveConfig_600_29_LB()
	...
	_Ini_Add("attack", "ABDukeAtk", BitAND($g_aiAttackUseHeroes[$LB], $eHeroDuke))
...
Func SaveConfig_600_35_1()
	...
	_Ini_Add("General", "LastLeagueTier", Number($g_aiCurrentLoot[$eLootTrophy]))
