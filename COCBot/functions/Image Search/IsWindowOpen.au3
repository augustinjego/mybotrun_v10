...
; #FUNCTION# ====================================================================================================================
; Name ..........: CloseAttackWindow
; Description ...: Closes the attack window of CoC 18.600.5, which has no red [X] button
; Syntax ........: CloseAttackWindow()
; Return values .: True when something was closed
; Remarks .......: This file is part of MyBot Copyright 2015-2025
;                  The attack window is now a panel docked to the left edge and the only way
;                  to dismiss it is tapping the village beside it. A dialog opened on top of
;                  the panel still carries a real [X], so that is attempted first.
; ===============================================================================================================================
Func CloseAttackWindow()
	If CloseWindow2() Then Return True

	If Not $g_bAttackWindowNoCloseButtonLogged Then
		SetLog("Attack Window has no [X] button, closing it beside the panel instead", $COLOR_INFO)
		$g_bAttackWindowNoCloseButtonLogged = True
	EndIf

	ClickAway("Right") ; 640-650, 10-30 sits on the village, clear of the panel
	If _Sleep(1000) Then Return False
	Return True
EndFunc   ;==>CloseAttackWindow
